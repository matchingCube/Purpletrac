...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    imgUrl: function imgUrl() {
      if (_store_index__WEBPACK_IMPORTED_MODULE_8__["default"].state.appConfig.layout.skin === "dark") {
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          useJwt.login({
            ...
            _this2.$ability.update(userData.ability); // ? This is just for demo purpose as well.
            // ? Because we are showing eCommerce app's cart items count in navbar


            _this2.$store.commit("app-ecommerce/UPDATE_CART_ITEMS_COUNT", userData.extras.eCommerceCartItemsCount); // ? This is just for demo purpose. Don't think CASL is role based in this case, we used role in if condition just for ease


            _this2.$router.replace(Object(_auth_utils__WEBPACK_IMPORTED_MODULE_9__["getHomeRouteForLoggedInUser"])(userData.role)).then(function () {
              _this2.$toast({
                component: _core_components_toastification_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_10__["default"],
                position: "top-right",
                props: {
            ...
            _this2.$refs.loginForm.setErrors(error.response.data.error);
          });
        }
      });
    }
      ...
      _c(
        ...
        [
          ...
          _c(
            "b-col",
            {
              staticClass: "d-flex align-items-center auth-bg px-2 p-lg-4",
              attrs: { lg: "4" },
            },
            [
              _c(
